...
\subsection{Sequence Diagrams }
	...
	\subsubsection{Login and Registering}
		...
		\end{longtable}
		\centerline{\includegraphics[scale=0.75]{./images/loginAndRegister}}
	\subsubsection{Posting a Book}	
		\begin{longtable}{| l | p{8cm} |}
			...
			Miscellaneous & None \\ \hline
		\end{longtable}
		\centerline{\includegraphics[scale=0.75]{./images/postBookSequenceDiagram}}
	\subsubsection{Contacting a Seller}
		\begin{longtable}{| l | p{8cm} |}
			...
			Miscellaneous & None \\ \hline
		\end{longtable}
		\centerline{\includegraphics[scale=0.75]{./images/contactSellerSequence}}
